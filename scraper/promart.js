...
// VTEX catalog API — department paths for a home-improvement retailer.
const CATEGORIAS_BASE = [
  `${BASE}/api/catalog_system/pub/products/search/`,
  `${BASE}/api/catalog_system/pub/products/search/Herramientas/`,
  `${BASE}/api/catalog_system/pub/products/search/Pinturas/`,
  `${BASE}/api/catalog_system/pub/products/search/Muebles/`,
  `${BASE}/api/catalog_system/pub/products/search/Jardin/`,
  `${BASE}/api/catalog_system/pub/products/search/Iluminacion/`,
  `${BASE}/api/catalog_system/pub/products/search/Electrohogar/`,
];
...
function guessCategory(name) {
  ...
  if (/taladro|sierra|herramienta|llave|destornillador/.test(n)) return 'Herramientas';
  if (/pintura|brocha|rodillo|esmalte/.test(n))                  return 'Construcción';
  if (/sofa|cama|colchon|mesa|silla|closet/.test(n))             return 'Muebles';
  if (/jardin|planta|manguera|aspersor/.test(n))                 return 'Jardín';
